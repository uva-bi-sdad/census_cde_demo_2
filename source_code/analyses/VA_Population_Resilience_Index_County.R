...
RESconogeo<-st_drop_geometry(RESco); names(RESconogeo)
RESconogeo<-RESconogeo[,-(dim(RESconogeo)[2])]; names(RESconogeo)
write.csv(RESconogeo, "~/Documents/Counting People/Data/Derived Variables/va_county_population_resilience.csv", row.names=FALSE)
